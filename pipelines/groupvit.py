...
from transformers import GroupViTModel, AutoProcessor, GroupViTVisionModel
import torch
from tqdm import tqdm

class GroupViT_Pipeline(Model_Pipeline):
    def __init__(self, weights_name, label_texts, device="cpu"):
        super().__init__("groupvit", weights_name, device)
    ...
    def _Model_Pipeline__get_model(self):
        ...
        self.model = GroupViTModel.from_pretrained(self.weights_name)
        self.vision_model = GroupViTVisionModel.from_pretrained(self.weights_name)
